package com.yjjjwww.tabling.config;
...
public class JwtTokenProvider {
     ...
     * JWT 토큰 생성
     */
    public String createToken(String userId, Long id, UserType userType) {
        Claims claims = Jwts.claims().setSubject(userId).setId(id.toString());
